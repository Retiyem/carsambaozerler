...
function initializeThemeToggle() {
    ...
    if (nav) {
        nav.insertAdjacentHTML('afterend', themeToggleHTML);
...
function applyTheme(theme) {
    ...
    if (theme === 'light') {
        // Light tema renkleri
        root.style.setProperty('--bg-primary-dark', '#f5f5f5');
        root.style.setProperty('--bg-secondary-dark', '#ffffff');
        root.style.setProperty('--text-light', '#333333');
        root.style.setProperty('--glass-card-bg', 'rgba(255, 255, 255, 0.7)');
        root.style.setProperty('--glass-card-border', 'rgba(0, 0, 0, 0.1)');
        root.style.setProperty('--shadow-medium', 'rgba(0, 0, 0, 0.1)');
        
        if (themeIcon) themeIcon.textContent = '☀️';
    } else {
        // Dark tema renkleri (default)
        root.style.setProperty('--bg-primary-dark', '#1a1a2e');
        root.style.setProperty('--bg-secondary-dark', '#16213e');
        root.style.setProperty('--text-light', '#e0e0e0');
        root.style.setProperty('--glass-card-bg', 'rgba(0, 0, 0, 0.5)');
        root.style.setProperty('--glass-card-border', 'rgba(255, 255, 255, 0.1)');
        root.style.setProperty('--shadow-medium', 'rgba(0, 0, 0, 0.6)');
