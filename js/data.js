...
const players = [
    ...
    { id: 'muhammet_cakir', name: 'Muhammet ÇAKIR' },
...
const matches = [
    ...
    /*
    {
        ...
        performances: [
            ...
            { playerId: 'onur', team: 'A', goals: 0, assists: 0, weeklyMVP: false },
            { playerId: 'ensarb', team: 'A', goals: 0, assists: 0, weeklyMVP: false },
            { playerId: 'ahmets', team: 'A', goals: 0, assists: 0, weeklyMVP: false },
            { playerId: 'burakk', team: 'A', goals: 0, assists: 0, weeklyMVP: false },
            { playerId: 'emree', team: 'A', goals: 0, assists: 0, weeklyMVP: false },
            { playerId: 'enes', team: 'A', goals: 0, assists: 0, weeklyMVP: false },
            { playerId: 'omere', team: 'A', goals: 0, assists: 0, weeklyMVP: false },

            // B Takımı oyuncuları (7 kişi)
            { playerId: 'furkans', team: 'B', goals: 0, assists: 0, weeklyMVP: false },
            { playerId: 'furkany', team: 'B', goals: 0, assists: 0, weeklyMVP: false },
            { playerId: 'ibrahim', team: 'B', goals: 0, assists: 0, weeklyMVP: false },
            { playerId: 'tayyipb', team: 'B', goals: 0, assists: 0, weeklyMVP: false },
            { playerId: 'muhammetc', team: 'B', goals: 0, assists: 0, weeklyMVP: false },
            { playerId: 'muratcan', team: 'B', goals: 0, assists: 0, weeklyMVP: false },
            { playerId: 'orhan', team: 'B', goals: 0, assists: 0, weeklyMVP: false },
